      ...
      <div class="body-view">
        ...
        <svg viewBox="0 0 110 300" class="body-svg" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="11" y="77" width="12" height="36" rx="6"
            :class="mc('biceps')" @click="toggle('biceps')">
          ...
          <rect x="12" y="116" width="10" height="28" rx="5"
            :class="mc('forearms')" @click="toggle('forearms')">
          ...
          <rect x="38" y="88" width="34" height="46" rx="6"
            :class="mc('abs')" @click="toggle('abs')">
            <title>Abs</title></rect>

          <!-- Quads -->
          <rect x="31" y="150" width="22" height="66" rx="8"
            :class="mc('quads')" @click="toggle('quads')">
      ...
      <div class="body-view">
        ...
        <svg viewBox="0 0 110 300" class="body-svg" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M30,64 L54,44 L54,106 Q40,112 32,102 Q28,90 28,70 Z"
            :class="mc('lats')" @click="toggle('lats')">
          ...
          <rect x="38" y="106" width="34" height="22" rx="5"
            :class="mc('lower-back')" @click="toggle('lower-back')">
            <title>Lower Back</title></rect>

          <!-- Triceps -->
          <rect x="11" y="77" width="12" height="36" rx="6"
            :class="mc('triceps')" @click="toggle('triceps')">
          ...
          <rect x="31" y="150" width="22" height="32" rx="8"
            :class="mc('glutes')" @click="toggle('glutes')">
          ...
          <rect x="31" y="185" width="22" height="32" rx="8"
            :class="mc('hamstrings')" @click="toggle('hamstrings')">
...
function mc(id: string) {
  return ['muscle', props.selected.includes(id) ? 'active' : '']
}
</script>

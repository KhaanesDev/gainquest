<template>
  <div class="layout">
    ...
    <main class="main">
      ...
      <div class="card">
        <p style="color: var(--color-text-muted)">Workout logging coming in Phase 3.</p>
      </div>
    </main>
  </div>
</template>
...
.navbar { display: flex; align-items: center; gap: 24px; padding: 12px 24px; background: var(--color-surface); border-bottom: 1px solid var(--color-border); }
